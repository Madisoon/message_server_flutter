/// 所有接口
class Api {
  static final String baseUrl = "http://118.178.237.219:8080/";

  /// 获取所有需要推送的信息
  static final String allPostInformation = baseUrl + '/manage/getInforPost';

  /// 推送信息完成
  static final String postInformationFinish =
      baseUrl + '/manage/updateInforPost';

  /// 推送信息删除
  static final String postInformationDelete =
      baseUrl + '/manage/deleteInforPost';
